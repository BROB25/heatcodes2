  ...
  return (
    <div id='home' className='flex justify-center items-center flex-col mx-auto'>
      ...
      <div className='flex flex-nowrap flex-col justify-center items-center w-full text-center'>
        <h4 className='text-base md:text-xl text-stone-400 font-bold uppercase'>Web Design Services <span className='text-stone-700'>&nbsp;|&nbsp;</span> App Creation <span className='text-stone-700'>&nbsp;|&nbsp;</span> Innovation
        </h4>
