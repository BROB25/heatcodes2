  ...
  return (
    <div id='home' className='flex justify-center items-center flex-col mx-auto'>
      ...
      <div className='flex flex-nowrap flex-col justify-center items-center w-full text-center'>
        <h2 className='text-base md:text-xl text-stone-400 font-bold uppercase'>Custom Web Design Services</h2>
        ...
        <section className="flex flex-col md:flex-row justify-center">
          <div className="max-w-sm mx-6 my-8 flex justify-center flex-col items-center border border-2 py-8">
            ...
            <div className="p-6 bg-black">
              <h1 className="text-2xl font-bold text-white text-center">Custom Web Design</h1>
          ...
          <div className="max-w-sm mx-6 my-8 flex justify-center flex-col items-center border border-2 py-8">
            ...
            />
            <div className="p-6 bg-black">
              <h1 className="text-2xl font-bold text-white text-center">Local Web Designer</h1>
          ...
          <div className="max-w-sm mx-6 my-8 flex justify-center flex-col items-center border border-2 py-8">
            ...
            />
            <div className="p-6 bg-black">
              <h1 className="text-2xl font-bold text-white text-center">Responsive Web Design</h1>
