  ...
  return (
    <div id='portfolio' className='h-[500px] w-full'>
      <div className='flex flex-col justify-center items-center text-white'>
        <h1 className='text-3xl sm:text-4xl text-gray-400 font-bold pt-16 mb-8 slide-down'>Web Design Business <span className='text-orange-600 font-extrabold'>Portfolio</span></h1>
