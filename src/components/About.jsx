    ...
    <div id='about' className='flex flex-col lg:flex-row my-24 gap-8'>
      ...
      <div className="flex-1 justify-center">
        <div className='mx-auto h-full flex flex-col justify-center'>
          ...
          <p className='text-white mt-8 px-6 md:px-0 text-sm md:text-base'>Hi, I'm Brandon Roberts, a 30-year-old father and husband who has a passion for coding and creating. With my primary expertise in front-end languages, as well as experience with other programming languages, I have been able to bridge that alongside my creativity to form Heat Codes. My love for coding has been honed over the years, thanks to my background in IT from my military service and various tech-related careers.</p><br></br>
          <p className='text-white px-6 md:px-0 text-sm md:text-base'>I find joy in designing, and solving problems through coding, and my experience has helped me develop a keen eye for detail and precision. Whether it's designing visually appealing layouts or tackling complex coding obstacles, I'm always up to the challenge. My mission is to provide the best web design services in Minnesota.</p>
